...
This repository provides the Postgres database connection, AI integration and GraphQL API for the [Ascentrade frontend](https://github.com/Ascentrade/frontend).
...
## Data Sources
Currently the following data sources are crawled
- [Yahoo Finance](https://finance.yahoo.com/)
- [CBOE options statistics](https://markets.cboe.com/us/options/market_statistics/daily/)
- [CNN Fear and Greed](https://money.cnn.com/data/fear-and-greed/)
- [EODHD](https://eodhd.com/) (for different indices)
...
```
Copyright (C) 2026 Dennis Greguhn and Pascal Dengler
